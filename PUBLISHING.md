...
Search and recent-package catalogs are asynchronous. A live npm version and direct pi.dev package page are authoritative; do not republish because a search index is delayed. Check search indexing with:
